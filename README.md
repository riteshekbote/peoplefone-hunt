...
24/7 deep multi-model bug-hunting automation for **peoplefone GmbH** (Oliver Maicher bug-bounty hub).

Scope: All company-owned infrastructure, VoIP platforms, SIP services, PBX systems, APIs, customer portals, mobile and desktop applications, and domains operated by peoplefone GmbH and its group entities
...
> is never accepted. Active testing is gated behind the in-scope hosts in `inventory/peoplefone.md` and
...
Program description: European VoIP and cloud telephony provider for business communication
