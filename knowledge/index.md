...
- 2026-09-13 ACCEPTED AUTH @ auth.peoplefone.com: 44th frozen re-verify 01:08Z — register 500 (all locales) / token GET 405 + POST(client_id=1)→401 + POST(no-body)→500 / stateless authorize 404+attacker redirect_uri cookie (httponly, secure, Max-Age 34560000, exp 2027-10-18) / api-doc 200; NO_DELTA; triage VALID on open-redirect+login-CSRF.
- 2026-09-13 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (44th frozen cycle); triage HOLD pending bearer token.
- 2026-09-13 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (44th frozen cycle); triage HOLD.
- 2026-09-13 ACCEPTED OTH @ pipeline: ROOT CAUSED empty-lead triage defect — triage.yml:45 greps literal `[UNVALIDATED]`; hunt.yml appends `[HYP]/[NEXT]` blocks; verified 0 occurrences in leads/*.md → new-leads.txt always empty → mimo receives empty LEADS (8+ consecutive empty runs incl. 09-12 23:19Z); last contentful gate 09-12 14:13 (7 VALID). Fix: anchor grep to `^\[HYP\]|^\[NEXT\]`.
...
- 2026-09-13 ACCEPTED OTH @ pipeline: repo re-check 12:27Z — triage.yml:45 fix NOT applied (literal `[UNVALIDATED]` grep intact), lead-mimo.md seed-only; the 8-empty-run defect remains live in-repo; precise repro of the starvation is confirmed and the remedy validated, blocker is purely the outstanding human edit.
- 2026-09-13 ACCEPTED AUTH @ auth.peoplefone.com: 45th frozen re-verify 12:27Z (fresh, no cookies) — api-doc 200 / bare register 404 / stateless authorize 404 + encrypted attacker redirect_uri cookie (secure, httponly, Max-Age 34560000, exp 2027-10-18) / token 401 known+500 nonexistent; NO_DELTA; triage VALID on open-redirect+login-CSRF.
- 2026-09-13 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (45th frozen cycle); triage HOLD pending bearer token.
- 2026-09-13 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (45th frozen cycle); triage HOLD.
...
- 2026-09-14 ACCEPTED OTH @ pipeline: Fix VERIFIED against repo — triage.yml:45 literal-`[UNVALIDATED]` grep feeds gate nothing; `grep -hE '^\[HYP\]|^\[NEXT\]' leads/lead-*.md` returns 25 lines, closing the 8-empty-run defect (last contentful gate 09-12 14:13). Note: bigpickle's 3 literal `[UNVALIDATED]` hits are meta-mentions within the root-cause text — confirms the accidental-substring failure mode is real and the anchored regex is the correct remedy.
- 2026-09-14 ACCEPTED AUTH @ auth.peoplefone.com: 50th frozen re-verify 07:06Z — api-doc 200 (0.88s); stateless authorize 404 + encrypted attacker `redirect_uri` cookie (secure, httponly, Max-Age 34560000, exp 2027-10-19); NO_DELTA; gate VALID stands at 09-12 14:13.
- 2026-09-14 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (50th frozen cycle).
- 2026-09-14 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (50th frozen cycle).
- 2026-09-14 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (49th frozen cycle); triage HOLD pending bearer token.
- 2026-09-14 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (49th frozen cycle); triage HOLD.
- 2026-09-14 ACCEPTED AUTH @ auth.peoplefone.com: 51st frozen re-verify 14:15Z — api-doc 200 (0.81s); stateless authorize 404 + encrypted attacker `redirect_uri` cookie (secure, httponly, Max-Age 34560000, exp 2027-10-19; XSRF-TOKEN+peopoauth_session 28800 companions); token GET 405 / POST(client_id=1)→401 invalid_client; register 500; OIDC discovery 404; NO_DELTA; gate VALID stands at 09-12 14:13.
- 2026-09-14 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (51st frozen cycle).
...
- 2026-09-14 ACCEPTED AUTH @ auth.peoplefone.com: 53rd frozen re-verify — api-doc 200 (0.81s); stateless authorize 404 + encrypted attacker `redirect_uri` cookie (secure, httponly, Max-Age 34560000, exp 2027-10-19; XSRF-TOKEN + peopoauth_session Max-Age 28800 companions); NO_DELTA; gate VALID stands at 09-12 14:13.
- 2026-09-14 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (53rd frozen cycle).
- 2026-09-14 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (53rd frozen cycle).
- 2026-09-14 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (52nd frozen cycle);
- 2026-09-14 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (52nd frozen cycle); triage HOLD.
- 2026-09-15 ACCEPTED AUTH @ auth.peoplefone.com: 54th frozen cycle — fresh 09:16Z probe: api-doc 200 (0.90s); stateless authorize 404 + encrypted attacker `redirect_uri` cookie (secure, httponly, Max-Age 34560000, exp 2027-10-20; XSRF-TOKEN + peopoauth_session Max-Age 28800 companions); NO_DELTA; gate VALID stands at 09-12 14:13.
- 2026-09-15 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (54th frozen cycle).
- 2026-09-15 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (54th frozen cycle).
- 2026-09-15 REJECTED MISCONFIG @ *.peoplefone.com: unchanged — 19 guessed subdomains NXDOMAIN, no wildcard, no dangling CNAME targets.
- 2026-09-15 REJECTED MISCONFIG @ *.peoplefone.com: 19 guessed subdomains all NXDOMAIN → NO wildcard DNS; no dangling CNAME targets (all → managed Cloudflare). Corrects filed "wildcard-dominated" claim.
- 2026-09-15 ACCEPTED AUTH @ auth.peoplefone.com: POST /oauth/token no client_secret → invalid_client JSON for clients 1/4/5 (confidential); nonexistent ids 2,3,10,100,999,0,-1 → unhandled 500. Code-theft-exchange ATO falsified for known clients; ATO escalates only via HUMAN_ONLY implicit-flow test.
- 2026-09-15 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (53rd frozen cycle); triage HOLD pending bearer token.
- 2026-09-15 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (53rd frozen cycle); triage HOLD.
- 2026-09-15 REJECTED BUSLOGIC @ call-api queue agents: triage-formal INVALID (spec-silent on membership validation); removed from active set.
- 2026-09-15 ACCEPTED OTH @ auth.peoplefone.com: stateless authorize sets `redirect_uri` cookie (httponly, secure, 1-year expiry) with attacker-controlled value even on 404 response — server processes redirect_uri param partially in stateless mode; behavioral detail supports warm-session 302 reproduction path.
- 2026-09-15 ACCEPTED OTH @ inventory: call-api.peoplefone.com/services/api-doc/ 404 reconfirmed (2026-09-07); config-api docs 404 reconfirmed; all 8-spec backends match the 401/404-gated real-backend pattern.
- 2026-09-15 ACCEPTED OTH @ pipeline: Fix VERIFIED against repo — triage.yml:45 literal-`[UNVALIDATED]` grep feeds gate nothing; `grep -hE '^\[HYP\]|^\[NEXT\]' leads/lead-*.md` returns 25 lines, closing the 8-empty-run defect (last contentful gate 09-12 14:13). Note: bigpickle's 3 literal `[UNVALIDATED]` hits are meta-mentions within the root-cause text — confirms the accidental-substring failure mode is real and the anchored regex is the correct remedy.
- 2026-09-15 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (54th frozen cycle); triage HOLD pending bearer token.
- 2026-09-15 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (54th frozen cycle); triage HOLD.
- 2026-09-15 ACCEPTED AUTH @ auth.peoplefone.com: 55th frozen cycle — fresh 09:16Z probe: api-doc 200 (0.90s); stateless authorize 404 + encrypted attacker `redirect_uri` cookie (secure, httponly, Max-Age 34560000, exp 2027-10-20; XSRF-TOKEN + peopoauth_session Max-Age 28800 companions); NO_DELTA; gate VALID stands at 09-12 14:13.
...
- 2026-09-15 ACCEPTED OTH @ pipeline: triage.yml:45 literal `\[UNVALIDATED\]` grep reconfirmed INTACT via repo read this cycle; 22:18Z triage fed 17 leads, 100% INVALID — accidental-substring mechanism live; gate cannot re-confirm OAuth; fix outstanding 13+ cycles. Apply anchored `^\[HYP\]|^\[NEXT\]`.
- 2026-09-15 ACCEPTED AUTH @ auth.peoplefone.com: 57th frozen cycle — 19:49Z baseline (api-doc 200 / stateless authorize 404 + encrypted attacker `redirect_uri` cookie exp 2027-10-20 / token 405) holds; NO_DELTA; probes add nothing; gate VALID stands at 09-12 14:13.
- 2026-09-15 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (57th frozen cycle); triage HOLD pending bearer token.
...
- 2026-09-16 ACCEPTED AUTH @ auth.peoplefone.com: 59th frozen cycle — fresh probe: api-doc 200 (0.95s); stateless authorize 404 + encrypted attacker `redirect_uri` cookie (exp 2027-10-21); NO_DELTA; gate VALID stands at 09-12 14:13.
- 2026-09-16 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (59th frozen cycle); triage HOLD pending bearer token.
- 2026-09-16 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (59th frozen cycle); triage HOLD.
- 2026-09-16 REJECTED MISCONFIG @ *.peoplefone.com: unchanged — 19 guessed subdomains NXDOMAIN, no wildcard, no dangling CNAME targets; no in-scope alternative surface.
- 2026-09-16 ACCEPTED AUTH @ auth.peoplefone.com: 60th frozen cycle — fresh 11:48Z probes: api-doc 200 / token 405 GET / stateless authorize 404 + encrypted attacker `redirect_uri` cookie exp 2027-10-21 11:48:55Z (secure, httponly, Max-Age 34560000) + XSRF-TOKEN/peopoauth_session 28800 / register 500 fresh; NO_DELTA; gate VALID stands at 09-12 14:13.
...
- 2026-09-17 REJECTED MISCONFIG @ *.peoplefone.com: 19 guessed subdomains all NXDOMAIN → NO wildcard DNS; no dangling CNAME targets (all → managed Cloudflare). Corrects filed "wildcard-dominated" claim.
- 2026-09-17 ACCEPTED AUTH @ auth.peoplefone.com: POST /oauth/token no client_secret → invalid_client JSON for clients 1/4/5 (confidential); nonexistent ids 2,3,10,100,999,0,-1 → unhandled 500. Code-theft-exchange ATO falsified for known clients; ATO escalates only via HUMAN_ONLY implicit-flow test.
- 2026-09-17 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (57th frozen cycle); triage HOLD pending bearer token.
- 2026-09-17 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (57th frozen cycle); triage HOLD.
- 2026-09-17 REJECTED BUSLOGIC @ call-api queue agents: triage-formal INVALID (spec-silent on membership validation); removed from active set.
...
- 2026-09-17 ACCEPTED OTH @ pipeline: triage.yml:45 literal `\[UNVALIDATED\]` grep reconfirmed INTACT via repo read this cycle; 22:18Z triage fed 17 leads, 100% INVALID — accidental-substring mechanism live; gate cannot re-confirm OAuth; fix outstanding 13+ cycles. Apply anchored `^\[HYP\]|^\[NEXT\]`.
- 2026-09-17 REJECTED MISCONFIG @ *.peoplefone.com: 19 guessed subdomains all NXDOMAIN → NO wildcard DNS; no dangling CNAME targets (all → managed Cloudflare). Corrects filed "wildcard-dominated" claim.
- 2026-09-17 ACCEPTED AUTH @ auth.peoplefone.com: POST /oauth/token no client_secret → invalid_client JSON for clients 1/4/5 (confidential); nonexistent ids 2,3,10,100,999,0,-1 → unhandled 500. Code-theft-exchange ATO falsified for known clients; ATO escalates only via HUMAN_ONLY implicit-flow test.
- 2026-09-17 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (58th frozen cycle); triage HOLD pending bearer token.
- 2026-09-17 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (57th frozen cycle); triage HOLD.
- 2026-09-17 REJECTED BUSLOGIC @ call-api queue agents: triage-formal INVALID (spec-silent on membership validation); removed from active set.
- 2026-09-17 ACCEPTED OTH @ auth.peoplefone.com: stateless authorize sets `redirect_uri` cookie (httponly, secure, 1-year expiry) with attacker-controlled value even on 404 response — server processes redirect_uri param partially in stateless mode; behavioral detail supports warm-session 302 reproduction path.
- 2026-09-17 ACCEPTED OTH @ inventory: call-api.peoplefone.com/services/api-doc/ 404 reconfirmed (2026-09-07); config-api docs 404 reconfirmed; all 8-spec backends match the 401/404-gated real-backend pattern.
...
- 2026-09-17 ACCEPTED AUTH @ auth.peoplefone.com: 65th frozen cycle — fresh re-probe this cycle api-doc 200 (0.80s) + stateless authorize 404 + encrypted attacker redirect_uri cookie (secure, httponly, Max-Age=34560000, exp 2027-10-22) + XSRF-TOKEN/peopoauth_session; NO_DELTA; gate VALID stands at 09-12 14:13.
- 2026-09-17 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (65th frozen cycle); triage HOLD pending bearer token.
...
- 2026-09-18 REJECTED MISCONFIG @ *.peoplefone.com: 19 guessed subdomains all NXDOMAIN → NO wildcard DNS; no dangling CNAME targets (all → managed Cloudflare). Corrects filed "wildcard-dominated" claim.
- 2026-09-18 ACCEPTED AUTH @ auth.peoplefone.com: POST /oauth/token no client_secret → invalid_client JSON for clients 1/4/5 (confidential); nonexistent ids 2,3,10,100,999,0,-1 → unhandled 500. Code-theft-exchange ATO falsified for known clients; ATO escalates only via HUMAN_ONLY implicit-flow test.
- 2026-09-18 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (65th frozen cycle); triage HOLD pending bearer token.
- 2026-09-18 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (65th frozen cycle); triage HOLD.
- 2026-09-18 REJECTED BUSLOGIC @ call-api queue agents: triage-formal INVALID (spec-silent on membership validation); removed from active set.
- 2026-09-18 ACCEPTED OTH @ auth.peoplefone.com: stateless authorize sets `redirect_uri` cookie (httponly, secure, 1-year expiry) with attacker-controlled value even on 404 response — server processes redirect_uri param partially in stateless mode; behavioral detail supports warm-session 302 reproduction path.
- 2026-09-18 ACCEPTED OTH @ inventory: call-api.peoplefone.com/services/api-doc/ 404 reconfirmed (2026-09-07); config-api docs 404 reconfirmed; all 8-spec backends match the 401/404-gated real-backend pattern.
- 2026-09-18 ACCEPTED OTH @ pipeline: triage.yml:45 literal `\[UNVALIDATED\]` grep reconfirmed INTACT via repo read this cycle; gate cannot re-confirm OAuth; fix outstanding 19+ cycles. Apply anchored `^\[HYP\]|^\[NEXT\]`.
- 2026-09-18 ACCEPTED AUTH @ auth.peoplefone.com: NO_DELTA 68th frozen cycle — register 500 all locales / token GET 405 + POST 401 known / stateless authorize 404 + attacker-value redirect_uri cookie / api-doc 200; consistent with 00:30 triage VALID; no new surface, probes add nothing.
- 2026-09-18 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence 68th frozen cycle; rank holds top; token-gated.
...
- 2026-09-18 ACCEPTED AUTH @ auth.peoplefone.com: NO_DELTA 70th frozen cycle — fresh probes: api-doc 200 (0.80s) / stateless authorize 404 + attacker-value redirect_uri cookie (secure, httponly, Max-Age 34560000, exp 2027-10-23) / XSRF-TOKEN+peopoauth_session 28800 companions; consistent with 00:30 triage VALID; no new surface, probes add nothing.
- 2026-09-18 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence 70th frozen cycle; rank holds top; token-gated.
...
- 2026-09-18 ACCEPTED AUTH @ auth.peoplefone.com: NO_DELTA 71st frozen cycle — fresh probes 21:2xZ: api-doc 200 (0.97s) / stateless authorize 404 + attacker-value redirect_uri cookie (secure, httponly, Max-Age 34560000, exp 2027-10-23 23:22:32Z) + XSRF-TOKEN/peopoauth_session 28800 companions; consistent with 00:30 triage VALID; no new surface, probes add nothing.
- 2026-09-18 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence 71st frozen cycle; rank holds top; token-gated.
- 2026-09-18 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence 71st frozen cycle; retained pending token.
- 2026-09-18 ACCEPTED OTH @ pipeline: triage.yml:45 literal `\[UNVALIDATED\]` grep reconfirmed INTACT (20+ cycles); anchored fix verified but unapplied; gate cannot re-confirm OAuth.
- 2026-09-19 REJECTED MISCONFIG @ *.peoplefone.com: 19 guessed subdomains all NXDOMAIN → NO wildcard DNS; no dangling CNAME targets (all → managed Cloudflare). Corrects filed "wildcard-dominated" claim.
- 2026-09-19 ACCEPTED AUTH @ auth.peoplefone.com: POST /oauth/token no client_secret → invalid_client JSON for clients 1/4/5 (confidential); nonexistent ids 2,3,10,100,999,0,-1 → unhandled 500. Code-theft-exchange ATO falsified for known clients; ATO escalates only via HUMAN_ONLY implicit-flow test.
- 2026-09-19 ACCEPTED IDOR @ configuration-api {identifier} CRUD: no counter-evidence; rank holds; token-gated (71st frozen cycle); triage HOLD pending bearer token.
- 2026-09-19 ACCEPTED SSRF @ 5 callback endpoints: no counter-evidence; retained pending token (71st frozen cycle); triage HOLD.
- 2026-09-19 REJECTED BUSLOGIC @ call-api queue agents: triage-formal INVALID (spec-silent on membership validation); removed from active set.
